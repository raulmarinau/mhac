...
SOURCES_PHYSICS_PROBLEMS = src/problems/TSP.cpp
SOURCES = $(SOURCES_BINDINGS) $(SOURCES_LOGGER) $(SOURCES_PHYSICS_PROBLEMS) $(SOURCES_ALG_PHYSICS) ${SOURCES_ALG_MATH} ${SOURCES_ALG_EVOLUTIONARY} ${SOURCES_ALG_SWARM} $(SOURCES_RANDOM)
